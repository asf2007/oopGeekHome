...
public class App {
    public static void main(String[] args) throws Exception {
       ...
       System.out.println(AccountController.averageAge(listStud));
        ...
        teachers.create("Валентина", 43);
        teachers.create("Юлия", 41);
        teachers.create("Антон", 35);
        teachers.sortByFIO();
        teachers.printTeachers();
        System.out.println("средний возраст учителей: " + AccountController.averageAge(teachers.getAll()));
